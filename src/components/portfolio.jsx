...
const Portfolio = () =>
{
  ...
  return(
    <div className={`min-h-screen ${darkMode ? 'dark' : ''}`}>
        <div className="bg-indigo-950 min-h-screen transition-colors duration-300">
...

          {
            ...
            <>
              ...
              <img src="img/20230829_132432.jpg" alt="" className="w-4/5 sm:w-1/4 h-min mx-auto rounded-full mb-20" />
...

          {
            ...
            <>
              ...
              <button className="text-cyan-200 text-lg sm:text-2xl font-bold bg-black px-4 py-2 rounded-xl border border-violet-700 border-4 hover:scale-110 transition duration-200" onClick={() => setPage("Home")}>Retourner à l'accueil</button>
            </>
          }
