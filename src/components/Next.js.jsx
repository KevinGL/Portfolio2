...
const projects = [
  {
    title: "Transactor",
    description: "Application de gestion des dépenses et revenus en temps réel, codé en Typescript avec Next.js et BDD FirebaseUne application conçue pour la répartition des tâches entre travailleurs, les admins créent les tâches et les répartissent, et les utilisateurs traitent et valident les tâches au fur et à mesure",
  ...
  {
    title: "Visiomatch",
    description: "Application de rencontre par speed dating vidéo, codé en Typescript, elle offre des sessions de speed dating visio les mardis, jeudis et dimanches soirs. Elle utilise des technologies telles que web sockets et webRTC pour faire les échanges vidéos et la messagerie instantanée",
